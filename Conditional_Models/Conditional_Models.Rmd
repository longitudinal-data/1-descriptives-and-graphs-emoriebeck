...
```{r, eval = T}
data_path <- "~/Dropbox (Brown)/Fall 2017/Longitudinal Data Analysis/Notes/Conditional Models"
load(paste(data_path, "sample.RData", sep = "/"))
...
\tiny
```{r,results='hide'}
# time invariant covariate with random intecept but not slope
